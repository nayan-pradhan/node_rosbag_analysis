...
# # IDEA: Store all in list first, then iterate and analyse
...
#         print(len(list_cmd_vel_msg))
#         print(len(list_is_mission_active_msg))
#         print(len(list_state_machine_event_log_msg))
